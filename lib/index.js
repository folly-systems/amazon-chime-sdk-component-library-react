...
function useUniqueId() {
    var uniqueId = React.useState(function () { return uuid.v4(); })[0];
    return uniqueId;
}
...
var reducer$2 = function (state, action) {
    ...
    switch (type) {
        case exports.ActionType.ADD: {
            var notification = __assign({ id: uuid.v4() }, payload);
...
var MeetingManager = /** @class */ (function () {
    function MeetingManager(config, deviceController) {
        var _this = this;
    ...
    MeetingManager.prototype.join = function (_a) {
        var meetingInfo = _a.meetingInfo, attendeeInfo = _a.attendeeInfo, _b = _a.deviceLabels, deviceLabels = _b === void 0 ? exports.DeviceLabels.AudioAndVideo : _b, eventReporter = _a.eventReporter;
    ...
    MeetingManager.prototype.initializeMeetingSession = function (configuration, deviceLabels) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger = this.logger ? this.logger : this.createLogger(configuration);
                        ...
                        if (!this.deviceController) {
                            this.deviceController = new amazonChimeSdkJs.DefaultDeviceController(logger);
                        }
                        this.meetingSession = new amazonChimeSdkJs.DefaultMeetingSession(configuration, logger, this.deviceController, this.eventReporter);
                        this.audioVideo = this.meetingSession.audioVideo;
                        this.setupAudioVideoObservers();
                        this.setupDeviceLabelTrigger(deviceLabels);
                        return [4 /*yield*/, this.listAndSelectDevices(deviceLabels)];
                    case 1:
                        _a.sent();
                        this.publishAudioVideo();
    ...
    MeetingManager.prototype.listAndSelectDevices = function (deviceLabels) {
        var _a, _b;
        if (deviceLabels === void 0) { deviceLabels = exports.DeviceLabels.AudioAndVideo; }
        return __awaiter(this, void 0, void 0, function () {
            var isAudioDeviceRequested, isVideoDeviceRequested, error_8, error_9;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (typeof deviceLabels === 'function')
                            return [2 /*return*/];
                        isAudioDeviceRequested = false;
                        isVideoDeviceRequested = false;
                        switch (deviceLabels) {
...
var LocalVideoProvider = function (_a) {
    ...
    var value = React.useMemo(function () { return ({ tileId: tileId, isVideoEnabled: isVideoEnabled, setIsVideoEnabled: setIsVideoEnabled, toggleVideo: toggleVideo, }); }, [
        tileId,
        isVideoEnabled,
        setIsVideoEnabled,
        toggleVideo,
...
var MeetingProvider = function (_a) {
    var _b = _a.logLevel, logLevel = _b === void 0 ? amazonChimeSdkJs.LogLevel.WARN : _b, postLogConfig = _a.postLogConfig, _c = _a.simulcastEnabled, simulcastEnabled = _c === void 0 ? false : _c, logger = _a.logger, videoDownlinkBandwidthPolicy = _a.videoDownlinkBandwidthPolicy, meetingManagerProp = _a.meetingManager, children = _a.children;
    var meetingManager = React.useState(function () { return meetingManagerProp || new MeetingManager({ logLevel: logLevel, postLogConfig: postLogConfig, simulcastEnabled: simulcastEnabled, logger: logger, videoDownlinkBandwidthPolicy: videoDownlinkBandwidthPolicy }); })[0];
...
var PreviewVideo = function (props) {
    ...
    var _a = useLocalVideo(), isVideoEnabled = _a.isVideoEnabled, setIsVideoEnabled = _a.setIsVideoEnabled;
    React.useEffect(function () {
