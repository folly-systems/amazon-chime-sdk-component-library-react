import { AudioVideoFacade, ConsoleLogger, DefaultDeviceController, DefaultMeetingSession, LogLevel, MeetingSessionConfiguration, MeetingSessionStatus, AudioVideoObserver, MultiLogger, EventReporter, VideoDownlinkBandwidthPolicy, Logger } from 'amazon-chime-sdk-js';
...
export declare class MeetingManager implements AudioVideoObserver {
    ...
    join({ meetingInfo, attendeeInfo, deviceLabels, eventReporter }: MeetingJoinData): Promise<void>;
    start(): Promise<void>;
    leave(): Promise<void>;
