...
var MeetingManager = /** @class */ (function () {
    ...
    MeetingManager.prototype.join = function (_a) {
        var meetingInfo = _a.meetingInfo, attendeeInfo = _a.attendeeInfo, _b = _a.deviceLabels, deviceLabels = _b === void 0 ? DeviceLabels.AudioAndVideo : _b, eventReporter = _a.eventReporter;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.meetingSession = new DefaultMeetingSession(configuration, logger, this.deviceController, this.eventReporter);
...
var LocalVideoProvider = function (_a) {
    ...
    var value = useMemo(function () { return ({ tileId: tileId, isVideoEnabled: isVideoEnabled, setIsVideoEnabled: setIsVideoEnabled, toggleVideo: toggleVideo, }); }, [
        tileId,
        isVideoEnabled,
        setIsVideoEnabled,
        toggleVideo,
...
var MeetingProvider = function (_a) {
    var _b = _a.logLevel, logLevel = _b === void 0 ? LogLevel.WARN : _b, postLogConfig = _a.postLogConfig, _c = _a.simulcastEnabled, simulcastEnabled = _c === void 0 ? false : _c, logger = _a.logger, videoDownlinkBandwidthPolicy = _a.videoDownlinkBandwidthPolicy, meetingManagerProp = _a.meetingManager, children = _a.children;
    var meetingManager = useState(function () { return meetingManagerProp || new MeetingManager({ logLevel: logLevel, postLogConfig: postLogConfig, simulcastEnabled: simulcastEnabled, logger: logger, videoDownlinkBandwidthPolicy: videoDownlinkBandwidthPolicy }); })[0];
